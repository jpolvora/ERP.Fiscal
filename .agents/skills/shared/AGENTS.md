...
Install packages and dependency map (upstream `workflow-skills` repo only; optional in consumers): `bin/skill-dependencies.json` when present at the install root.
