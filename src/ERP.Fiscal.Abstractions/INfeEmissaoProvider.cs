...
/// <summary>
/// Emissão, consulta, cancelamento e obtenção de artefatos (XML/PDF) de NF-e junto ao provedor fiscal.
/// A implementação recebe o payload JSON já pronto — a montagem do payload a partir do domínio
/// (produtos, cliente, natureza de operação, tributos) é responsabilidade de cada ERP.
/// </summary>
public interface INfeEmissaoProvider
{
